...
<section role="main" class="content-body">
	<header class="page-header">
		<h2><a href="{{route('mitra.index')}}">Master Mitra</a> | Show</h2> 
			...
			<section class="panel">
				<div class="panel-body">
					<div class="thumb-info mb-md">
						<img src="{{ asset('images/backend_images/images/!logged-user.jpg') }}" class="rounded img-responsive" alt="John Doe">
						<div class="thumb-info-title">
							<span class="thumb-info-inner">Nama Mitra</span>
							<span class="thumb-info-type">Tagline</span>
						</div>
					</div>
		...
		<div class="col-md-8 col-lg-6">
			...
			<div class="tabs">
				<ul class="nav nav-tabs tabs-primary">
					...
					<li>
						<a href="#edit" data-toggle="tab">Pemilik</a>
					</li>
				</ul>
				<div class="tab-content">
					<div id="overview" class="tab-pane active">
						<h4 class="mb-xlg">Timeline Order</h4>
...
<script src="{{ asset('vendor/jquery-autosize/jquery.autosize.js') }}"></script>
@endsection